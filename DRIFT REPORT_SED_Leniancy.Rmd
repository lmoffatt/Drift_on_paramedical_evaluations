...
data {
   ...
   real  fp_mean__d_logit_score__d_ntest_prior;
   real <lower=0> fp_sd_mean_d_logit_score__d_ntest_prior;
...
//   vector[nCT] sn_category_logit_score_prior;
   ...
   real sn_mean__d_logit_score__d_ntest_prior;
...
//   fp_sd_log_sd_category_logit_score_prior+fp_mean_log_sd_category_logit_score_prior);
  ...
  real sd_dimension_logit_score_prior=exp(sn_sd_log_sd_dimension_logit_score_prior*
   ...
   real mean_d_logit_score__d_ntest_prior=sn_mean__d_logit_score__d_ntest_prior*
   fp_sd_mean_d_logit_score__d_ntest_prior+fp_mean__d_logit_score__d_ntest_prior;
...
//        sd_logit_beta_prior+mean_logit_beta_prior);
 //     }
  ...
  //    category_logit_score[iCategory[i]]+
      ...
      itestEvaluator[i]*mean_d_logit_score__d_ntest_prior+
      mean_logit_score;
   }   
...
//   prior+=normal_lpdf(sn_category_logit_score_prior|0,1);
   ...
   prior+=normal_lpdf(sn_mean__d_logit_score__d_ntest_prior|0,1);
...
data_to_stan<-function(d)
{
   ...
   fp_mean__d_logit_score__d_ntest_prior=0,
   fp_sd_mean_d_logit_score__d_ntest_prior=logit(0.6)/10,
